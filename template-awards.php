                                ...
                                <div class="row">
                                    ...
                                    <div class="small-7 medium-5 large-4 columns">
                                        <?php if( get_field('thumbnail') ): ?>
                                            ...
                                            <?php elseif( get_field('external_link') || ( get_field('external_link') && get_field('link') ) ): ?>
                                                <a target="_blank" href="<?php the_field('external_link'); ?>">
                                                    <img class="lazy" src="<?php echo IMAGES; ?>blank.gif" data-original="<?php echo $img[0]; ?>" width="<?php echo $img[1]; ?>" height="<?php echo $img[2]; ?>">
                                                </a>
                                            <?php else: ?>
                                                <img class="lazy" src="<?php echo IMAGES; ?>blank.gif" data-original="<?php echo $img[0]; ?>" width="<?php echo $img[1]; ?>" height="<?php echo $img[2]; ?>">
                                    ...
                                    <div class="small-13 medium-12 large-13 columns">
                                        <div class="row">
                                            ...
                                            <div class="small-20 medium-10 columns">
                                                <div class="name">
                                                    <?php if( get_field('link') ): ?>
                                                        <a href="<?php the_field('link'); ?>"><?php the_field('project_product_name'); ?></a>
                                                    <?php else: ?>
                                                        <?php the_field('project_product_name'); ?>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
