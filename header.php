                        ...
                        <div class="small-16 medium-6 columns">
                            <div class="logo">
                                <a href="<?php echo home_url(); ?>">
                                    <span class="span-one">
                                        <img src="<?php echo IMAGES; ?>shelton-mindel.svg"
                                            alt="Shelton, Mindel &amp; Associates, Inc.">
                                    </span>
                            ...
                            <nav>
                                <ul class="navigation">
                                    <li class="desktop-link link"><a
                                            class="<?php if( is_page(7) ){ echo 'current'; } ?>"
                                            href="<?php echo get_permalink(7); ?>">Exhibitions</a></li>
                                    <li class="desktop-link link"><a
                                            class="<?php if( is_page(10) ){ echo 'current'; } ?>"
                                    ...
                                    <li class="desktop-link link has-subnav">
                                        <a class="<?php if( is_page( array(12,14,16,18) ) ){ echo 'current'; } ?>"
                                            href="javascript:void(0)">About <i class="fa fa-caret-down"></i></a>
                                        <ul class="subnav">
                                            <li class="subnav-link"><a
                                                    class="<?php if( is_page(12) ){ echo 'current'; } ?>"
                                                    href="<?php echo get_permalink(12); ?>">Profile</a></li>
                                            <li class="subnav-link"><a
                                                    class="<?php if( is_page(18) ){ echo 'current'; } ?>"
                                                    href="<?php echo get_permalink(18); ?>">Publications</a></li>
                                            <li class="subnav-link"><a
                                                    class="<?php if( is_page(5378) ){ echo 'current'; } ?>"
                                                    href="<?php echo get_permalink(5378); ?>">Careers</a></li>
                                        </ul>
                                    </li>
                                    <li class="desktop-link link"><a
                                            class="<?php if( is_page(27) ){ echo 'current'; } ?>"
                                            href="<?php echo get_permalink(27); ?>">Contact</a></li>
